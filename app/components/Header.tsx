    ...
    <>
      ...
      <div className="bg-[#c2f500] text-[#0d0d0d] text-xs py-1.5 font-semibold">
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
          {/* Mobile: één bericht gecentreerd */}
          <span className="md:hidden w-full text-center">Gratis verzending vanaf €40,-</span>

          {/* Desktop: alle berichten */}
          <div className="hidden md:flex gap-6">
            <span>Gratis verzending vanaf €40,-</span>
            <span>Vandaag besteld, morgen in huis</span>
            <span>Gratis retourneren</span>
          </div>
          <div className="hidden md:flex gap-4 text-[#0d0d0d]/70">
      ...
      <header className="bg-white border-b border-black/5 sticky top-0 z-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="hidden md:flex flex-1 max-w-2xl mx-auto">
            <div className="flex w-full rounded-none overflow-hidden border border-black/10 focus-within:border-[#c2f500]/60 transition-colors">
              <input
                type="text"
                value={searchQuery}
          ...
          <div className="flex items-center gap-4 shrink-0 ml-auto md:ml-0">
            ...
            <button className="hidden md:flex flex-col items-center text-xs gap-0.5 text-[#111111]/60 hover:text-[#c2f500] transition-colors">
            ...
            >
              ...
              <span className="hidden md:block">Winkelwagen</span>
            </button>
          </div>
        </div>
        ...
        <div className="md:hidden px-4 pb-3">
          <div className="flex rounded-none overflow-hidden border border-black/10 focus-within:border-[#c2f500]/60 transition-colors">
            <input
              ...
              className="flex-1 px-3 py-2 text-sm outline-none text-[#111111] bg-[#f5f5f5] placeholder-black/30"
            />
            <button className="bg-[#c2f500] px-4 py-2 flex items-center justify-center">
              <svg className="w-4 h-4 text-[#0d0d0d]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607z" />
              </svg>
            </button>
          ...
          <div className="max-w-7xl mx-auto px-4 flex items-center gap-0 overflow-x-auto scrollbar-hide">
            {[
              ...
              <button
                ...
                className={`whitespace-nowrap text-xs md:text-sm py-3 px-3 md:px-4 transition-colors border-b-2 ${
                  activeTab === label
