...
export const products: Product[] = [
  ...
  {
    id: 10,
    name: "Whey Proteïne Shake Aardbei",
    brand: "MaxMuscle",
    price: 34.95,
    originalPrice: 44.95,
    rating: 4.7,
    reviewCount: 987,
    emoji: "🍓",
    image: "https://images.unsplash.com/photo-1622484212850-eb596d769edc?w=400&h=350&q=80&auto=format&fit=crop",
    badge: "Top keuze",
    category: "shakes",
    description: "Premium whey proteïne met 24g eiwit per portie, heerlijk van smaak",
    features: [
      "24g whey proteïne per portie",
      "Slechts 130 kcal per shake",
      "Verrijkt met BCAA's voor spierherstel",
      "Geen toegevoegde suikers",
      "Geschikt voor lactose-intolerantie",
    ],
    flavors: ["Aardbei", "Chocolade", "Vanille", "Mango"],
    weight: "750g",
    servings: 25,
  },
  {
    id: 11,
    name: "Dieet Shake Cookies & Cream",
    brand: "SlimShape",
    price: 28.99,
    originalPrice: 36.99,
    rating: 4.2,
    reviewCount: 654,
    emoji: "🍪",
    image: "https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=400&h=350&q=80&auto=format&fit=crop",
    badge: "Aanbieding",
    category: "shakes",
    description: "Voedzame maaltijdshake voor gewichtsbeheersing, 18g proteïne",
    features: [
      "18g proteïne per portie",
      "Slechts 200 kcal per shake",
      "Toegevoegde vezels voor langdurige verzadiging",
      "Verrijkt met 20 vitaminen en mineralen",
      "Glutenvrij en geschikt voor vegetariërs",
    ],
    flavors: ["Cookies & Cream", "Chocolade Fudge", "Vanille", "Karamel"],
    weight: "500g",
    servings: 14,
  },
  {
